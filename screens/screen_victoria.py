...
from settings import AMARILLO, BLANCO, NEGRO
...
class ScreenVictoria:
    ...
    def dibujar(self, pantalla):
        ...
        titulo = self.fuente_titulo.render("¡Victoria!", True, AMARILLO)
        info = self.fuente_info.render(
            f"Ganaste ${self.gm.dinero_acumulado}. Presiona ESPACIO para volver al inicio.",
            True,
            BLANCO,
        )
